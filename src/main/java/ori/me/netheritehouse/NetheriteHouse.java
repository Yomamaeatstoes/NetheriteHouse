...
public final class NetheriteHouse extends JavaPlugin implements CommandExecutor {

    @Override
    public void onEnable() {
        // Plugin startup logic
        getCommand("netherite").setExecutor(this);
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(label.equalsIgnoreCase("netherite")){
            pasteHouse(p.getLocation(), new File(getDataFolder().getAbsolutePath() + "/schematics/netherite.schematic"));
        }
        return true;
    }
